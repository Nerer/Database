...
public class SystemTestUtil {
    ...
    public static void matchTuples(DbIterator iterator, List<ArrayList<Integer>> tuples)
        ...
        int kk = 0;
        /*if (tuples.size() > 1000) {
            System.out.println(iterator.getTupleDesc());
        }*/
        while (iterator.hasNext()) {
            /*if (tuples.size() > 1000) {
                //System.out.println(kk++);
                System.out.println(kk++ + " " + ((SeqScan)iterator).getIt().getcur());
            }*/
            Tuple t = iterator.next();
            if (tuples.size() > 1000) {
                //System.out.println(kk++);
                //System.out.println(kk++ + " " + ((SeqScan)iterator).getIt().getcur() + " " + ((SeqScan)iterator).getIt().getmax());
            }
